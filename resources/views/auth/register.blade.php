        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="btn btn-primary" class="nav-link" href="{{route('register.index')}}">Registrarse</a>
              </li>
              <li class="nav-item">
                <a class="btn btn-secondary" class="nav-link" href="{{route('login.index')}}">Iniciar Sesion </a>
              </li>
